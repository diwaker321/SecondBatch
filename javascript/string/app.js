...
// console.log( nname.trimEnd().length);
// console.log( nname.trim().length);
...
// addition in string / concat in string 
...
// Template Literal
// how to add string with variables 
// string indexing 
// length property 
